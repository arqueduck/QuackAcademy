  ...
  return (
    <>
      ...
      <div className="p-4">
        ...
        <p>Sabia que as tecnologias mais complexas que existem no mercado hoje, até mesmo aquelas que você usa diariamente, precisaram de um ponto de partida lógico bem simples?</p>
        <p>Pra exemplificar este cenário, vamos construir juntos um site do 0, para mostrar que qualquer pessoa pode fazer isso, basta se dedicar um pouquinho.</p>
